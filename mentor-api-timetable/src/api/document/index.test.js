...
model_1.GenericFileUpload.create = jest.fn().mockResolvedValue({
    originalFileName: "example.txt",
    fileKey: "unique-file-key",
    createdAt: new Date(),
});
describe("Docment API - Mock testing ", () => {
    test("POST doUploadService", () => __awaiter(void 0, void 0, void 0, function* () {
        model_1.GenericFileUpload.create = jest.fn().mockResolvedValue({
            originalFileName: "example.txt",
            fileKey: "unique-file-key",
            createdAt: new Date(),
        ...
        yield (0, service_1.doUploadService)(req, res);
        expect(model_1.GenericFileUpload.create).toHaveBeenCalledWith({
            originalFileName: "example.txt",
        });
    ...
    test("POST doUploadService - Error during S3 upload", () => __awaiter(void 0, void 0, void 0, function* () {
        model_1.GenericFileUpload.create = jest.fn().mockResolvedValue({
            originalFileName: "example.txt",
            fileKey: "unique-file-key",
            createdAt: new Date(),
    ...
    test("POST doUploadService - GenericFileUpload.create Failure", () => __awaiter(void 0, void 0, void 0, function* () {
        model_1.GenericFileUpload.create = jest
            .fn()
    ...
    test("GET doDownloadService Successful Download", () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            params: {
        ...
        yield (0, service_1.doDownloadService)(req, res);
        expect(res.status).toHaveBeenCalledWith(500);
        expect(res.json).toHaveBeenCalledWith({
            error: "Error -> dest.on is not a function",
        });
    }));
    test("GET doDownloadService S3 Client Error", () => __awaiter(void 0, void 0, void 0, function* () {
        const req = {
            params: {
                filekey: "test-file-key",
            },
