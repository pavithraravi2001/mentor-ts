...
export const validateExcelData = (data) => {
  const schema = Joi.object({
    firstName: Joi.string()
      .regex(validationRegx.NAME_ALLOW_SPACE_AND_DOTS)
      .required("Firstname is mandatory"),

    middleName: Joi.string().regex(validationRegx.NAME_ALLOW_SPACE_AND_DOTS),
    ...
    aadhaarNumber: Joi.string()
      .regex(validationRegx.AADHAR_REGX)
    ...
    fatherAnnualSalary: Joi.string().regex(validationRegx.SALARY_REGX),
    ...
    motherAnnualSalary: Joi.string()
      .regex(validationRegx.SALARY_REGX)
    ...
    emergencyContactRelationship: Joi.string().required(
      "Emergency Contact relationship is mandatory"
    ),
    ...
    permanentAddressLine1: Joi.string().required(
      "Permanent Address is mandatory"
    ),

    permanentAddressLine2: Joi.string().required(
      "Permanent Address is mandatory"
    ),
    ...
    permanentAddressZipCode: Joi.string()
      .regex(validationRegx.PIN_CODE_NUMBER_REGX)
      .required("Pincode is mandatory"),

    communicationAddressLine1: Joi.string().required(
      "Communication Address is mandatory"
    ),

    communicationAddressLine2: Joi.string().required(
